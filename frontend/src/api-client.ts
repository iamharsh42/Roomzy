...
}; // send a post request to signout endpoint.
...
export const fetchMyHotels = async (): Promise<HotelType[]> => {
    ...
    return response.json();
} // request to fetch hotels from backend
...
export const fetchMyHotelById = async (hotelId: string): Promise<HotelType> => {
    ...
    return response.json();
} // request to fetch a particular hotel based on it s HotelID.
...
//     const response = await fetch(`${API_BASE_URL}/api/hotrls/search?${queryParams}`);
...
//     return response.json();
// }  // request to fetch search results
...
export const fetchHotels = async (): Promise<HotelType[]> => {
    ...
    return response.json();
}; // request to get the list of hotels for home page
...
export const fetchHotelById = async (hotelId: string): Promise<HotelType> => {
    ...
    return response.json();
}; // request to fetch hotels details
...
export const createPaymentIntent = async (hotelId: string, numberOfNights: string): Promise<PaymentIntentResponse> => {
    ...
    return response.json();
};  // request sent to backend to create payment intent
